...
for key_user_index in list(set(omegau_test).intersection(user_songs.user_index.values)):
    songlist = []
...
map = apk_sum/len(set(omegau_test).intersection(user_songs.user_index.values))