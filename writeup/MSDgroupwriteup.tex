...
The sample data set had  $163206$ songs  $110000$ users, and the number of play counts 
...
In order to perform the analysis, we had to fill in a matrix which contained play counts for user and song pairs. We then did a random selection by data element to split between the training (80\%) and testing (20\%) sets. 
