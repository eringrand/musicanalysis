...
The benchmark we used to compare our MAP scores against was recommending the top 500 most popular songs to every user. This naive method resulted in a MAP score of 0.013 (top 500 songs based on counts) or 0.012 (top 500 songs based on plays).
